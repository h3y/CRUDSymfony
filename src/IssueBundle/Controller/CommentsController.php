...
use IssueBundle\Entity\Comments;
...
class CommentsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $comments = $em->getRepository('IssueBundle:Comments')->findAll();
    ...
    {
        $comment = new Comment();
        $form = $this->createForm('IssueBundle\Form\CommentsType', $comment);
    ...
    {
        $deleteForm = $this->createDeleteForm($comment);
        $editForm = $this->createForm('IssueBundle\Form\CommentsType', $comment);
